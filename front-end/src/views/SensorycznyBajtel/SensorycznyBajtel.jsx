  ...
  return (
    <Layout>
      <CenteredContent>
        <ZajeciaGrupoweView>
          <div className={styles.h1DescriptionWrapper}>
            ...
            <div className={styles.description}>
              ...
              <p>
                Program Sensorycznego Bajtla opracowany jest dla każdego
                dziecka, a zwłaszcza dla tych z grupy ryzyka zaburzeń integracji
              ...
              <p>
                ...
                hałasować i mruczeć, wspinać się i huśtać, przytulać się i
                turlać, smakować i wąchać, a także rzucać, biegać, dotykać,
                układać i eksplorować!
              </p>
              <h2>
                Garstka ważnych informacji – Sensoryczny Bajtel to zajęcia:
              </h2>
              <ul>
        ...
        <AllAboutUs selectedEmployeesId={[3]} />
      </CenteredContent>
    </Layout>
  );
}
