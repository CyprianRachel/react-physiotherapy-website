export const SERVICES = [
  ...
  },
  {
    ...
    servicesList: [
      ...
      {
        serviceName: "Trening funkcjonalny dzieci (od 7 roku życia)",
        description: "",
        price: "150min",
        time: "1g 15min",
      },
      {
        serviceName: "Przyjazna pielęgnacja - instruktaż",
        description: "",
        price: "150min",
        time: "1g 15min",
      },
    ...
    servicesList: [
      {
        serviceName: "Część I - Wywiad z rodzicem (bez dziecka)",
        description:
          "W in.motion Diagnoza Procesów Przetwarzania Sensorycznego składa się z trzech części, które obejmują: wywiad z rodzicem/prawnym opiekunem, spotkanie diagnostyczne z dzieckiem oraz szczegółowe omówienie wyników przeprowadzonej diagnozy. Termin każdej części ustala się osobno i niezależnie od pozostałych spotkań. WAŻNE: termin części III ustalany jest w kontakcie bezpośrednim z diagnostą SI po zakończeniu części II badania. Część I obejmuje szczegółowy wywiad z rodzicem/opiekunem prawnym na temat okresu przed narodzeniem dziecka, okresu okołoporodowego oraz czasu po narodzinach. Konieczne jest zabranie ze sobą: książeczki zdrowia dziecka, kompletu ewentualnych badań i konsultacji specjalistycznych oraz opinii wychowawcy przedszkola lub szkoły. Spotkanie odbywa się bez obecności dziecka i trwa około 50 minut.  Na zakończenie spotkania rodzic/opiekun prawny otrzymuje Kwestionariusz Rozwoju Sensomotorycznego dziecka. Wypełniony dokument należy zabrać ze sobą na II część diagnozy SI.",
        price: "80,00",
        time: "45min",
      },
      {
